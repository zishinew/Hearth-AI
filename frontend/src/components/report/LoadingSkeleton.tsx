        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <main className="w-full lg:w-[70%] space-y-8">
            <div className="bg-white rounded-lg p-6">
              <div className="h-96 w-full bg-slate-200 rounded animate-pulse"></div>
              <div className="h-6 w-3/4 bg-slate-200 rounded animate-pulse mt-4"></div>
            </div>
            <div className="space-y-4">
              ...
              <div className="flex gap-4 overflow-x-auto">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-64 h-48 bg-slate-200 rounded animate-pulse"
                  ></div>
                ))}
              </div>
            </div>
